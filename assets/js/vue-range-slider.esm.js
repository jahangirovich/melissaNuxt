  ...
  props: {
    ...
    tooltip: {
      ...
      validator: function validator(val) {
        return ['hover', 'always'].indexOf(val) > -1 || val === false;
      }
    },
    // 组件方向
    direction: {
  ...
  render: function render(h) {
    ...
    if (this.isRange) {
      var dot0 = h('div', {
        ...
        style: [this.dotStyles, this.dotStyle, !this.boolDisabled && this.disabledArray[0] ? this.disabledDotStyles[0] : null, this.sliderStyles[0], this.focusFlag && this.focusSlider === 0 ? this.focusStyles[0] : null]
      }, [h('div', {
        ref: 'tooltip0',
      ...
      var dot1 = h('div', {
        ...
        style: [this.dotStyles, this.dotStyle, !this.boolDisabled && this.disabledArray[1] ? this.disabledDotStyles[1] : null, this.sliderStyles[1], this.focusFlag && this.focusSlider === 1 ? this.focusStyles[1] : null]
      }, [h('div', {
        ref: 'tooltip1',
        staticClass: 'slider-tooltip-wrap',
      ...
      var dot = h('div', {
        ...
        style: [this.dotStyles, this.dotStyle, this.sliderStyles, this.focusFlag && this.focusSlider === 0 ? this.focusStyles : null]
      }, [h('div', {
        staticClass: 'slider-tooltip-wrap',
